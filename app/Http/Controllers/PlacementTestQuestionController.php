...
class PlacementTestQuestionController extends Controller
{
    ...
    private function validatedQuestion(Request $request, ?PlacementTestQuestion $question = null): array
    {
        ...
        $validated = $request->validate([
            ...
            'points' => ['required', 'numeric', 'decimal:0,2', 'min:0.01', 'max:999999.99'],
            ...
            'points.numeric' => 'Soru puanı sayı olmalıdır.',
            'points.decimal' => 'Soru puanında en fazla iki ondalık basamak kullanın.',
            'points.min' => 'Soru puanı sıfırdan büyük olmalıdır.',
            'points.max' => 'Soru puanı çok yüksektir.',
