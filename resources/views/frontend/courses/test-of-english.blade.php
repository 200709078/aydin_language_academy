...
<head>
    <meta charset="utf-8">
    <title>Test of English | {{ __('dictt.ala') }}</title>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid rounded w-100" src="{{ asset('frontend/images/whoweare.png') }}" alt="Test of English">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="mb-4">Test of English</h1>
                    <p>Test of English hedeflerinize uygun dil becerilerini ve sınav yaklaşımını geliştirmeye yönelik demo kurs içeriği.</p>
