...
<head>
    <meta charset="utf-8">
    <title>{{ __('dictt.test_of_english') }} | {{ __('dictt.ala') }}</title>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid rounded w-100" src="{{ asset('frontend/images/whoweare.png') }}" alt="{{ __('dictt.test_of_english') }}">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="mb-4">{{ __('dictt.test_of_english') }}</h1>
                    <p>{{ __('dictt.test_of_english_intro') }}</p>
