...
<head>
    <meta charset="utf-8">
    <title>YKS-DİL Hazırlık | {{ __('dictt.ala') }}</title>
...
<body>
    ...
    <!-- YKS-DİL Hazırlık Course Start -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid rounded w-100" src="{{ asset('frontend/images/whoweare.png') }}" alt="YKS-DİL Hazırlık">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="mb-4">YKS-DİL Hazırlık</h1>
                    <p>YKS-DİL sınavına hazırlanan öğrenciler için kelime, dil bilgisi, okuma ve soru çözme becerilerini destekleyen demo program.</p>
