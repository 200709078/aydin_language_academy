...
<head>
    <meta charset="utf-8">
    <title>{{ __('dictt.yks_dil_prep') }} | {{ __('dictt.ala') }}</title>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 order-2 wow fadeIn" data-wow-delay="0.5s">
                    <img class="img-fluid rounded w-100" src="{{ asset('frontend/images/courses/yks-dil.jpg') }}" alt="{{ __('dictt.yks_dil_prep') }}">
                ...
                <div class="col-lg-6 order-1 wow fadeIn" data-wow-delay="0.1s">
                    <h1 class="mb-4 d-flex align-items-center gap-2">
                        ...
                        <span>{{ __('dictt.yks_dil_prep') }}</span>
                    </h1>
                    <p class="mb-0">{{ __('dictt.yks_dil_intro') }}</p>
                </div>
            </div>
        </div>
    </div>
