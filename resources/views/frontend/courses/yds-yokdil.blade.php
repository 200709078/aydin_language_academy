...
<head>
    <meta charset="utf-8">
    <title>YDS / YÖKDİL | {{ __('dictt.ala') }}</title>
...
<body>
    ...
    <!-- YDS / YÖKDİL Course Start -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid rounded w-100" src="{{ asset('frontend/images/whoweare.png') }}" alt="YDS / YÖKDİL">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="mb-4">YDS / YÖKDİL</h1>
                    <p>YDS ve YÖKDİL sınavlarına hazırlık için demo içerik ve çalışma programı.</p>
