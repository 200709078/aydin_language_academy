...
<head>
    <meta charset="utf-8">
    <title>{{ __('dictt.toefl') }} | {{ __('dictt.ala') }}</title>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 order-2 wow fadeIn" data-wow-delay="0.5s">
                    <img class="img-fluid rounded w-100" src="{{ asset('frontend/images/courses/toefl.jpg') }}" alt="{{ __('dictt.toefl') }}">
                ...
                <div class="col-lg-6 order-1 wow fadeIn" data-wow-delay="0.1s">
                    <h1 class="mb-4 d-flex align-items-center gap-2">
                        ...
                        <span>{{ __('dictt.toefl') }}</span>
                    </h1>
                    <p class="mb-0">{{ __('dictt.toefl_intro') }}</p>
                </div>
            </div>
        </div>
    </div>
