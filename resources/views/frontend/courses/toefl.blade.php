...
<head>
    <meta charset="utf-8">
    <title>TOEFL | {{ __('dictt.ala') }}</title>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid rounded w-100" src="{{ asset('frontend/images/whoweare.png') }}" alt="TOEFL">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="mb-4">TOEFL</h1>
                    <p>TOEFL sınavının temel bölümlerine ve akademik iletişim becerilerine yönelik demo hazırlık içeriği.</p>
