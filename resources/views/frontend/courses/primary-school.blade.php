...
<body>
    ...
    <!-- Primary School Course Start -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 order-2 wow fadeIn" data-wow-delay="0.5s">
                    <img class="img-fluid rounded w-100" src="{{ asset('frontend/images/courses/ilkokul.jpg') }}" alt="{{ __('dictt.primary_school') }}">
                ...
                <div class="col-lg-6 order-1 wow fadeIn" data-wow-delay="0.1s">
                    <h1 class="mb-4 d-flex align-items-center gap-2">
                        ...
                        <span>{{ __('dictt.primary_school') }}</span>
                    </h1>
                    <p class="mb-0">{{ __('dictt.primary_school_intro') }}</p>
                </div>
            </div>
        </div>
    </div>
    <!-- Primary School Course End -->
