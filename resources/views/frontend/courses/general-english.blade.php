...
<head>
    <meta charset="utf-8">
    <title>{{ __('dictt.seo_general_english_title') }}</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="{{ __('dictt.seo_general_english_keywords') }}" name="keywords">
    <meta content="{{ __('dictt.seo_general_english_description') }}" name="description">
...
<body>
    ...
    <!-- General English Course Start -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 order-2 wow fadeIn" data-wow-delay="0.5s">
                    <img class="img-fluid rounded w-100" src="{{ asset('frontend/images/courses/genel-ingilizce.jpg') }}" alt="{{ __('dictt.general_english') }}">
                ...
                <div class="col-lg-6 order-1 wow fadeIn" data-wow-delay="0.1s">
                    <h1 class="mb-4 d-flex align-items-center gap-2">
                        ...
                        <span>{{ __('dictt.general_english') }}</span>
                    </h1>
                    <p class="mb-0">{{ __('dictt.general_english_intro') }}</p>
                </div>
            </div>
        </div>
    </div>
    <!-- General English Course End -->
