...
<head>
    <meta charset="utf-8">
    <title>{{ __('dictt.seo_branch_title', ['branch' => 'Köyceğiz']) }}</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="{{ __('dictt.seo_branch_keywords') }}, Muğla Köyceğiz Dil Kursu" name="keywords">
    <meta content="{{ __('dictt.seo_branch_description', ['branch' => 'Köyceğiz']) }}" name="description">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                ...
                <!-- Mobil: 2. koycegiz-1.jpg | PC: sol üst -->
                ...
                <!-- Mobil: 4. koycegiz-2.jpg | PC: sağ alt -->
                <div class="col-lg-6 order-4 order-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <img class="img-fluid rounded d-block mx-auto ala-branch-secondary-image" src="{{ asset('frontend/images/branches/koycegiz-2.jpg') }}" alt="Köyceğiz">
                </div>
            </div>
        </div>
    </div>
