...
<body>
    ...
    <div class="container-xxl pt-5 pb-0">
        <div class="container">
            ...
            <p class="mb-4">{{ __('dictt.ortaca_intro') }}</p>
            ...
            <p class="mb-4">{{ __('dictt.ortaca_outro') }}</p>
            <div class="row g-5">
            ...
            <section class="pt-5">
                ...
                <p class="mb-4">{{ __('dictt.dalaman_intro') }}</p>
                ...
                <p class="mb-0">{{ __('dictt.dalaman_outro') }}</p>
            ...
            <section class="pt-5">
                ...
                <p class="mb-4">{{ __('dictt.koycegiz_intro') }}</p>
                ...
                <p class="mb-0">{{ __('dictt.koycegiz_outro') }}</p>
                <div class="row g-5 mt-1">
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
