...
<head>
    <meta charset="utf-8">
    <title>{{ __('dictt.branch_ortaca') }} | {{ __('dictt.ala') }}</title>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid rounded w-100" src="{{ asset('frontend/images/branches/ala_ortaca.jpg') }}" alt="{{ __('dictt.branch_ortaca') }}">
                    <div class="mt-4">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="mb-4">{{ __('dictt.branch_ortaca') }}</h1>
