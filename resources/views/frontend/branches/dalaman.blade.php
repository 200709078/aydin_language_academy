        ...
        <div class="container">
            <div class="row g-5">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="bg-light rounded d-flex align-items-center p-3 mb-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h5 class="mb-0"><a class="text-dark text-break" href="tel:+905308284884">(530) 828 4884</a></h5>
                            </div>
                        </div>
                        <div class="bg-light rounded d-flex align-items-center p-3 mb-4">
                            <div class="d-flex flex-shrink-0 align-items-center justify-content-center rounded-circle bg-white" style="width: 55px; height: 55px;">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p>Aydın Language Academy, Dalaman'da İngilizce öğrenmek isteyenler için mükemmel bir seçenektir. Kaliteli eğitim ve uzman öğretmenlerimizle, dil becerilerinizi geliştirmek için size yardımcı oluyoruz.</p>
                    ...
                    <p>Dalaman'da İngilizce öğrenmek isteyen herkes için Aydın Language Academy mükemmel bir seçenektir. Bizimle iletişime geçin ve dil becerilerinizi geliştirmeye bugün başlayın!</p>
                </div>
            </div>
        </div>
    </div>
