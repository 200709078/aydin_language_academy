...
<head>
    <meta charset="utf-8">
    <title>{{ __('dictt.seo_branch_title', ['branch' => 'Dalaman']) }}</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="{{ __('dictt.seo_branch_keywords') }}, Muğla Dalaman Dil Kursu" name="keywords">
    <meta content="{{ __('dictt.seo_branch_description', ['branch' => 'Dalaman']) }}" name="description">
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 order-1 order-lg-2 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p>{{ __('dictt.dalaman_section_3_title') }}<br>{{ __('dictt.dalaman_section_3_text') }}</p>
                    <p>{{ __('dictt.dalaman_section_4_title') }}<br>{{ __('dictt.dalaman_section_4_text') }}</p>
                    <p>{{ __('dictt.dalaman_section_5_title') }}<br>{{ __('dictt.dalaman_section_5_text') }}</p>
                    <p>{{ __('dictt.dalaman_outro') }}</p>
                </div>
                <!-- Mobil: 2. dalaman-1.jpg | PC: sol üst -->
                        ...
                        <a class="text-decoration-none" href="https://maps.google.com/?cid=13451178032151641036&g_mp=CiVnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLkdldFBsYWNlEAMYASAF&hl=tr&gl=TR&source=embed" target="_blank" rel="noopener noreferrer">
                            <div class="bg-light rounded d-flex align-items-center p-3 mb-4">
                                ...
                                <div class="ms-3">
                                    ...
                                    <h5 class="mb-0"><span class="text-dark text-break">Karaçalı Mahallesi, Şehit Hamza Atakul Caddesi No:39/A Dalaman/Muğla</span></h5>
                                </div>
                            </div>
                        </a>
                        <a class="text-decoration-none" href="tel:+905308284884">
                            <div class="bg-light rounded d-flex align-items-center p-3 mb-4">
                                <div class="d-flex flex-shrink-0 align-items-center justify-content-center rounded-circle bg-white" style="width: 55px; height: 55px;">
                                ...
                                <div class="ms-3">
                                    ...
                                    <h5 class="mb-0"><span class="text-dark text-break">+905308284884</span></h5>
                                </div>
                            </div>
                        </a>
                        <a class="text-decoration-none" href="{{ route('frontend.contact', ['branch' => 'dalaman']) }}">
                            <div class="bg-light rounded d-flex align-items-center p-3 mb-4">
                                <div class="d-flex flex-shrink-0 align-items-center justify-content-center rounded-circle bg-white" style="width: 55px; height: 55px;">
                                ...
                                <div class="ms-3">
                                    ...
                                    <h5 class="mb-0"><span class="text-dark text-break">dalaman@learnenglishwithala.com</span></h5>
                                </div>
                            </div>
                        </a>
                ...
                <!-- Mobil: 4. dalaman-2.jpg | PC: sağ alt -->
                <div class="col-lg-6 order-4 order-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <img class="img-fluid rounded d-block mx-auto ala-branch-secondary-image" src="{{ asset('frontend/images/branches/dalaman-2.jpg') }}" alt="Dalaman">
                </div>
            </div>
        </div>
    </div>
