<nav id="admin-navigation" x-data="{
        ...
        siteSettingsOpen: {{ request()->routeIs('admin.users.*', 'reviews_list', 'review_edit', 'admin.messages.*', 'admin.news.*', 'admin.campaigns.*', 'admin.slogans.*', 'admin.achievements.*') ? 'true' : 'false' }},
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex min-h-16 items-center justify-between gap-6">
            <div class="hidden flex-1 items-center justify-start gap-2 lg:flex">
                ...
                <div class="admin-navigation-group">
                    <button type="button"
                        class="admin-navigation-trigger {{ request()->routeIs('admin.users.*', 'reviews_list', 'review_edit', 'admin.messages.*', 'admin.news.*', 'admin.campaigns.*', 'admin.slogans.*', 'admin.achievements.*') ? 'is-active' : '' }}"
                    ...
                    <div x-show="siteSettingsOpen" x-transition class="admin-navigation-collapse" style="display: none;">
                        ...
                        <a @click="closeSidebarOnMobile()" href="{{ route('admin.slogans.index') }}" class="admin-navigation-collapse-link {{ request()->routeIs('admin.slogans.*') ? 'is-active' : '' }}"><i class="fas fa-quote-left admin-navigation-subicon" aria-hidden="true"></i>{{ __('dictt.slogans') }}</a>
                ...
                <div class="admin-navigation-group">
                    ...
                    <div x-show="scholarshipOpen" x-transition class="admin-navigation-collapse" style="display: none;">
                        <a @click="closeSidebarOnMobile()" href="{{ route('admin.scholarship.applications.index') }}" class="admin-navigation-collapse-link {{ request()->routeIs('admin.scholarship.applications.*') ? 'is-active' : '' }}"><i class="fas fa-clipboard-list admin-navigation-subicon" aria-hidden="true"></i>{{ __('scholarship.applications') }}</a>
                        <a @click="closeSidebarOnMobile()" href="{{ route('admin.scholarship.attendance.index') }}" class="admin-navigation-collapse-link {{ request()->routeIs('admin.scholarship.attendance.*') ? 'is-active' : '' }}"><i class="fas fa-user-check admin-navigation-subicon" aria-hidden="true"></i>{{ __('scholarship.attendance_management') }}</a>
                        <a @click="closeSidebarOnMobile()" href="{{ route('admin.scholarship.scores.index') }}" class="admin-navigation-collapse-link {{ request()->routeIs('admin.scholarship.scores.*') ? 'is-active' : '' }}"><i class="fas fa-pen-to-square admin-navigation-subicon" aria-hidden="true"></i>{{ __('scholarship.score_management') }}</a>
                        <a @click="closeSidebarOnMobile()" href="{{ route('admin.scholarship.awards.index') }}" class="admin-navigation-collapse-link {{ request()->routeIs('admin.scholarship.awards.*') ? 'is-active' : '' }}"><i class="fas fa-award admin-navigation-subicon" aria-hidden="true"></i>{{ __('scholarship.award_management') }}</a>
