    ...
    <div class="card">
        <div class="card-body">
            <div class="row align-items-center mb-3">
                ...
                <h5 class="col-sm-4 card-title text-center mb-0">{{ __('dictt.addnewquestion') }}</h5>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="correct_answer" class="form-control">
                                <option @if (old('correct_answer') === 'answer1') selected @endif value="answer1">Answer 1
                                </option>
                                <option @if (old('correct_answer') === 'answer2') selected @endif value="answer2">Answer 2
                                </option>
                                <option @if (old('correct_answer') === 'answer3') selected @endif value="answer3">Answer 3
                                </option>
                                <option @if (old('correct_answer') === 'answer4') selected @endif value="answer4">Answer 4
                                </option>
                                <option @if (old('correct_answer') === 'answer5') selected @endif value="answer5">Answer 5
                                </option>
                            </select>
                        </div>
                    </div>
