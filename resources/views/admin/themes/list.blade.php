<x-app-layout>
    ...
    <div class="card">
        <div class="card-body">
            <a href="#" class="btn btn-sm btn-primary float-right" title="Add New Theme"><i class="fa fa-plus"></i> Add
                New Theme</a>
                ...
                <tbody>
                    @foreach ($themes as $theme)
                        <tr class="align-middle">
                            ...
                            <td>{{ $theme->image}}</td>
                            <td>
                                <a href="{{ route('declarations_list',$theme->id) }}" class="btn btn-sm btn-primary" title="Declarations List">
                                    <i class="fa fa-list w-4"></i></a>
                                <a href="{{ route('exercises_list',$theme->id) }}" class="btn btn-sm btn-warning" title="Exercises List">
                                    <i class="fa fa-list w-4"></i></a>
