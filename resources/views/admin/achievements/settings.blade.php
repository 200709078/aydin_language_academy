<x-app-layout>
    <x-slot name="header">{{ __('dictt.achievement_page_settings') }}</x-slot>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row align-items-center mb-3">
                ...
                <h5 class="col-sm-4 card-title text-center mb-0">{{ __('dictt.achievement_page_settings_edit') }}</h5>
                <div class="d-none d-sm-block col-sm-4"></div>
            </div>

            <form id="achievement-settings-form" method="POST"
                action="{{ route('admin.achievements.settings.update') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')

                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="title_tr" class="form-label">{{ __('dictt.achievement_page_title_tr') }}</label>
                        <input id="title_tr" type="text" name="title_tr"
                            value="{{ old('title_tr', $achievementPageSetting?->title_tr) }}"
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="title_en" class="form-label">{{ __('dictt.achievement_page_title_en') }}</label>
                        <input id="title_en" type="text" name="title_en"
                            value="{{ old('title_en', $achievementPageSetting?->title_en) }}"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="description_tr" class="form-label">{{ __('dictt.achievement_page_description_tr') }}</label>
                        <textarea id="description_tr" name="description_tr" rows="4"
                            class="form-control @error('description_tr') is-invalid @enderror" required>{{ old('description_tr', $achievementPageSetting?->description_tr) }}</textarea>
                        @error('description_tr')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="description_en" class="form-label">{{ __('dictt.achievement_page_description_en') }}</label>
                        <textarea id="description_en" name="description_en" rows="4"
                            class="form-control @error('description_en') is-invalid @enderror" required>{{ old('description_en', $achievementPageSetting?->description_en) }}</textarea>
                    ...
                    <div class="col-12 mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check mt-3">
                                    ...
                                    <label for="remove_hero_image" class="form-check-label">
                                        {{ __('dictt.achievement_page_remove_hero_image') }}
                                    </label>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="form-text">{{ __('dictt.achievement_page_hero_image_help') }}</div>
                        @error('hero_image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
