    ...
    <div class="card"><div class="card-body">
        ...
        <dl class="row">
            @foreach ([
                ...
                'correct_count' => $application->attendance_status === 'absent' ? __('scholarship.not_applicable') : ($application->correct_count ?? __('scholarship.not_entered')),
        ...
        <div class="border rounded p-3 mb-3">
            <h6>{{ __('scholarship.publication_management') }}</h6>
