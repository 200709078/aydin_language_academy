            ...
            <div class="row align-items-center mb-3">
                <div class="col-sm-4 mb-2 mb-sm-0">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <button type="submit" form="exercise-create-form" class="btn btn-success btn-sm">{{ __('dictt.save') }}</button>
                    </div>
                </div>
                <h5 class="col-sm-4 card-title text-center mb-0">{{ __('dictt.addnewexercises') }}</h5>
                <div class="d-none d-sm-block col-sm-4"></div>
            </div>
            <form id="exercise-create-form" method="POST" action="{{ route('exercise_store', $theme->id)}}" enctype="multipart/form-data">
                @csrf
