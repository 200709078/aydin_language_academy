...
<!--   <div class="container-fluid header bg-primary p-0 mb-5">
    ...
    <div class="col-lg-6">
      ...
      <div class="owl-carousel-item position-relative">
        <img class="img-fluid" src="{{ asset('front/') }}/img/slide2.png">
        <div class="owl-carousel-text">
        <h1 class="display-1 text-white mb-0">&nbsp;</h1>
        </div>
      </div>
  ...
  <div class="container-xxl py-5">
    ...
    <div class="row g-4">
      ...
      <div class="service-item bg-light rounded h-100 p-5">
        ...
        <p class="mb-4">Erat ipsum justo amet duo et elitr dolor, est duo duo eos lorem sed diam stet diam sed stet.
        </p>
...
<!--       <p class="d-inline-block border rounded-pill py-1 px-4">Doctors</p> -->
    ...
    <div class="row g-4">
      ...
      <div class="team-item position-relative rounded overflow-hidden">
        <div class="overflow-hidden">
        <img class="img-fluid" src="{{ asset('front/') }}/img/slide2.png" alt="">
        </div>
      </div>
      </div>
      ...
      <div class="bg-light rounded h-100 d-flex align-items-center p-5">
        ...
        <div class="row g-3">
          ...
          <div class="date" id="date" data-target-input="nearest">
            <input type="text" class="form-control border-0 datetimepicker-input" placeholder="Choose Date"
...
<!--   <div class="container-xxl py-5">
    ...
    <div class="owl-carousel testimonial-carousel">
      ...
      <div class="testimonial-text rounded text-center p-4">
        <p>Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed sed. Magna ut diam sit et
        amet stet eos sed clita erat magna elitr erat sit sit erat at rebum justo sea clita.</p>
