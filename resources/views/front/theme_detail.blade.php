            ...
            <form method="POST" action="{{ route('exercises.result', $exercise->id) }}">
                ...
                @foreach ($exercise->questions as $question)
                    ...
                    <div class="form-check mt-2">
                        <input class="form-check-input" type="radio" name="{{$question->id}}" id="exercises_{{$question->id}}_1"
                            value="answer1">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="{{$question->id}}" id="exercises_{{$question->id}}_2"
                            value="answer2">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="{{$question->id}}" id="exercises_{{$question->id}}_3"
                            value="answer3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="{{$question->id}}" id="exercises_{{$question->id}}_4"
                            value="answer4">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="{{$question->id}}" id="exercises_{{$question->id}}_5"
                            value="answer5">
                    ...
                    <hr>
                @endforeach
                <button type="SUBMIT" class="btn btn-success btn-sm btn-block" style="width: 100%;">Check Exercises</button>
            </form>
        </div>
    </div>
